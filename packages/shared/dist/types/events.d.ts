 ...
 */
export type EventAction = 'orchestrator.start' | 'orchestrator.command' | 'orchestrator.plan' | 'orchestrator.frontier.update' | 'orchestrator.task.scheduled' | 'orchestrator.complete' | 'fetch.start' | 'fetch.complete' | 'fetch.error' | 'fetch.cached' | 'extract.start' | 'extract.complete' | 'extract.error' | 'index.write' | 'index.query' | 'index.update' | 'graph.merge' | 'graph.query' | 'graph.update' | 'synthesis.start' | 'synthesis.complete' | 'synthesis.error' | 'system.health' | 'system.error';
/**
 * Agent type performing the action
 */
export type AgentType = 'orchestrator' | 'fetch' | 'extract' | 'index' | 'graph' | 'synthesis' | 'system';
/**
